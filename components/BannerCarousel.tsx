  ...
  const defaultBanners: Banner[] = [
    {
      ...
      subtitle: 'Il più piccolo smartphone flagship al mondo. Potenza massima, dimensioni minime.',
    ...
    },
    {
      ...
      subtitle: 'Lo smartwatch completo che sostituisce il tuo telefono. 4G LTE integrato.',
        ...
        {banners.map((banner, index) => (
          ...
          >
            ...
            <div className="absolute inset-0">
              ...
              />
              <div className={`absolute inset-0 bg-gradient-to-r ${banner.backgroundColor} opacity-50`}></div>
            </div>
